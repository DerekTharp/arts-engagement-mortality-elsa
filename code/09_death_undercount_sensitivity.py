...
Produces output/tables/death_undercount_sensitivity.csv.

Note: this is a stochastic simulation. The n_extra=0 rows are deterministic;
the n_extra>0 cells are simulation medians over 200 reps. The seed fixes the
run.
"""
import sys
