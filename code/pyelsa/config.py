...
Mirrors the globals and covariate lists in the original Stata pipeline
(00_master.do and the numbered scripts). Nothing downstream should redefine a
path, covariate list, or recode rule; import from here.
"""
from pathlib import Path

# ---------------------------------------------------------------------------
# Paths. PROJ is the repository root (parent of code/). One editable anchor,
# everything else derived, mirroring `global proj` in 00_master.do.
# ---------------------------------------------------------------------------
...
# Grouped discrete-time hazard periods (baseline hazard), from 05_msm_iptw.do.
